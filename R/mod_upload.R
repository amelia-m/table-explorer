          ...
          tags$tbody(
            ...
            tags$tr(
              ...
              tags$td(
                style = "padding:5px 10px;",
                if (!is.null(ex)) {
                  paste0(round(ex$size / 1024, 1), " KB")
                } else {
                  "\u2014"
                }
              ),
      ...
      if (length(result$relationships) > 0) {
        ...
        showNotification(
          paste0(
            "Schema imported: ",
            length(result$tables),
            " table(s), no relationships found."
          ),
          type = "message",
          duration = 5
        )
